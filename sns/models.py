...
class Subscription(models.Model):
    ...
    @classmethod
    def subscribe(cls, topic_label, protocal, browse_host):
        endpoint_url = browse_host + reverse("sns_endpoint")
        response = cls.aws_connection(topic_label).subscribe(topic_label, protocal, endpoint_url)
